...
export default function ConnectWallet({ userSession, userData, setUserData }) {
  ...
  return (
    <button
      className="px-4 py-2 font-sans font-bold text-white transition duration-500 ease-in-out rounded bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-800 hover:to-orange-500"
      onClick={() => {
